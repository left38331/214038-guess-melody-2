...
export const AuthorizationScreen = (props) => {
  return <section className="login">
    ...
    <form className="login__form" action="" onSubmit={props.formSubmitHandler}>
      <p className="login__field">
        <label className="login__label" htmlFor="email">Логин</label>
        <input className="login__input" type="text" name="email" id="email" onChange={props.userInputHandler}/>
      </p>
      <p className="login__field">
        <label className="login__label" htmlFor="password">Пароль</label>
        <input className="login__input" type="text" name="password" id="password" onChange={props.userInputHandler}/>
